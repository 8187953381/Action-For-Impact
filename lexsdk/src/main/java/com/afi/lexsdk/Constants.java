...
public class Constants {
    ...
    public static final String CLASSROOM_URL_E = "rtmp://13.233.169.96:1935/lexChannelE/instance1";
    public static final String GOLIVE_URL_D = "rtmp://13.234.41.45:1935/lexChannelD/instance1";
    ...
    public static String environmentType = "actionforimpact";//"space";
    public static boolean downloadAllowed = true;

    public static final String baseUrl = "https://www.actionforimpact.io"; //"https://space.sunbird.org";
...
//    public static final  CONTENT_URL_PREFIX_REGEX = "((http|https)://private-[a-zA-Z0-9-]*/)";
    ...
    public static final String persistenceFile = "com.infosysit.lexsdk.persistence.";
