...
import com.afi.actionforimpact.services.DownloadsBridge;
...
import com.afi.lexsdk.services.SqlCrudService;
...
import static com.afi.lexsdk.Constants.CANCELLED;
import static com.afi.actionforimpact.services.WebViewBridgeJava.listOfContents;
import static com.afi.lexsdk.Constants.FAILED;
import static com.afi.lexsdk.Constants.INITIATED;
...
//        infyTv.setVisibility(View.VISIBLE);
    ...
    public void openHotspot(View view) {
        Intent openRapPage = new Intent(DownloadsWebView.this, OpenRapActivity.class);
        openRapPage.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(openRapPage);
    }
