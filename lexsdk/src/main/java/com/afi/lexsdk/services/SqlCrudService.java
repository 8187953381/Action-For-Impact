...
public class SqlCrudService extends IntentService {
    ...
    private static final String ACTION_DELETE = "com.infosysit.lexsdk.services.action.DELETE";
    private static final String ACTION_CANCEL = "com.infosysit.lexsdk.services.action.CANCEL";
    private static final String ACTION_EXPIRY = "com.infosysit.lexsdk.services.action.EXPIRY";

    private static final String EXTRA_CONTENT_ID = "com.infosysit.lexsdk.services.extra.CONTENT_ID";
