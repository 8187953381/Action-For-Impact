...
public class UtilityJavaTest {
    ...
    public void getExtension_test1() throws Exception {
        ...
        String extension = UtilityJava.getExtension("http://10.177.157.30:3005/static-ilp/lex_5043407731031547000/lex_19036588158688145000/lex_13544714593934324000/quiz.json");
    ...
    public void getExtension_test2() throws Exception {
        boolean status = false;
        String extension = UtilityJava.getExtension("http://10.177.157.30:3005/static-ilp/lex_5043407731031547000/lex_19036588158688145000/lex_13544714593934324000/quiz");
        Log.d("ArtificatUrl",extension);
        if(extension.length()>1){
            status = true;
        }
