...
import com.afi.actionforimpact.services.OpenRapInterface;
import com.afi.lexsdk.Constants;
import com.afi.lexsdk.UtilityJava;
import com.afi.lexsdk.services.ApiInterfaceJava;
import com.afi.lexsdk.services.InstallAPK;
import com.afi.lexsdk.services.RetrofitSingleton;
...
import static com.afi.lexsdk.Constants.connectivityMessage;
import static com.afi.lexsdk.UtilityJava.isOnline;
...
public class Util {
    ...
    public static Call<Void> checkIfOpenRap() {
        OpenRapInterface openRapInterface = new Retrofit.Builder()
                .baseUrl("https://192.168.12.1")
                .addConverterFactory(GsonConverterFactory.create())
                .build().create(OpenRapInterface.class);
        return openRapInterface.checkIfOpenRap();
    }

    public static Call<Void> checkIfInternet() {
                Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://google.com")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        return retrofit.create(OpenRapInterface.class).checkIfInternet();

//        OpenRapInterface openRapInterface = new Retrofit.Builder()
//                .baseUrl("https://google.com/sjhff")
//                .client(okHttpClient)
//                .addConverterFactory(GsonConverterFactory.create())
//                .build().create(OpenRapInterface.class);
//        return openRapInterface.checkIfInternet();
    }
